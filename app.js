...
const toolsData = [
    ...
    },
    {
        name: "找倍數過河拱橋戰",
        category: "五上",
        path: "五上/找倍數過河拱橋戰.html",
        desc: "《找倍數過河拱橋戰》是一款訓練倍數心算與數感的趣味網頁遊戲。手動依序輸入指定個數的倍數，幫農夫搭起一座過河的木橋。過關可解鎖公倍數隱藏關，並支援計時積分與英雄榜！",
        type: "遊戲"
    },
    {
        name: "找倍數過河拱橋戰 (教師後台)",
        category: "五上",
        path: "五上/找倍數過河拱橋戰_教師後台.html",
        desc: "《找倍數過河拱橋戰》的教師管理端。即時監控學生作答的出錯數據與排行榜，並提供一鍵清空資料庫的功能。",
        type: "遊戲"
    },
    {
